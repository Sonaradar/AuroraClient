...
public abstract class FontLoaders {
    ...
    private static Font getKiona(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Aurora/AuroraFont.ttf")).getInputStream();
